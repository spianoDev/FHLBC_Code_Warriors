...
# web development meetup that you are organising. Three programming languages will be represented:
# Python, Ruby and JavaScript.
#
# Your task is to return either:
#
# true if the number of meetup participants representing any of the three programming languages is
# ** at most 2 times higher than the number of developers representing any of the remaining programming languages**
# ; or false otherwise.
...
def is_language_diverse(lst):
    lang_counter = {}
    for info in lst:
        if info['language'] in lang_counter:
            lang_counter[info['language']] += 1
        else:
            lang_counter[info['language']] = 1

    return float(max(lang_counter.values()))/2 <= min(lang_counter.values())
...
is_language_diverse(list1) # => False
is_language_diverse(list2) # => False
is_language_diverse(list3) # => True
is_language_diverse(list4) # => True
